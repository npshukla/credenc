...
async function getGoogleLogin() {
 ...
 await AsyncStorage.setItem('userLogin', 'true');
      AsyncStorage.setItem('linkedinToken', info.credentials);
      AsyncStorage.setItem('linkedinData', JSON.stringify(info.user));
...
console.log(profilestr);
 ...
 await AsyncStorage.setItem('userLogin', 'true');
      ...
      AsyncStorage.setItem('linkedinData', JSON.stringify(responseJson));
 ...
 _facebookData = async () => 
{
 ...
 var _this = this;
  const { navigate } = _this.props.navigation; 
   ...
   FBLoginManager.loginWithPermissions(["email"], async function(error, data){
  if (!error) {
    console.log("Login data: ", data);
    
    
    access_token = data.credentials.token;
    dataSave = data.profile;
   await  AsyncStorage.setItem('userLogin', 'true');
 await AsyncStorage.setItem('facebookToken', access_token);
...
GoogleSignin.signIn()
   ...
   await  AsyncStorage.setItem('userLogin', 'true');
 await AsyncStorage.setItem('facebookToken', access_token);
 //await AsyncStorage.setItem('facebookData', JSON.stringify(user));
