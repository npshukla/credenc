 ...
 */
String.prototype.scoremod1 = function(abbreviation) {
    ...
    // If the abbreviation is an exact substring of the string, almost perfect match.
    // Added by EFC to make sure that exact substrings match, which seems to be an
    // expectation of users. Otherwise a short exact substring match against a long
    // target might still not score high enough to show up in the result set.
    if (string.toLowerCase().indexOf(abbreviation.toLowerCase()) >= 0) {
    	return 0.95;
    }
