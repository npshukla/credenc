          ...
          ?
                ...
                {hideSubmitButton &&
                  <TouchableOpacity onPress={this._submitSelection}>
                    <IconIonic
                      ...
                      style={[styles.indicator, { paddingLeft: 15, paddingRight: 35 }]}
                    />
                  </TouchableOpacity>
                }
              </View>
            ...
            <View>
              <View style={styles.dropdownView}>
                <View style={[styles.subSection, { paddingTop: 10, paddingBottom: 10,paddingLeft:11 }]}>
                  <TouchableWithoutFeedback onPress={this._toggleSelector}>
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'flex-start' }}>
                      ...
                      <IconIonic
                        name={hideSubmitButton ? "md-arrow-dropdown" : "md-arrow-dropdown" }
